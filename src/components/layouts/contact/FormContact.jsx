            ...
            <div className="col-md-6">
                <div className="themesflat-headings style-2 clearfix">
                    ...
                    <p className="sub-heading">
                      Şeker Turizm Hizmetlerini öğrenmek ister misiniz? Hizmetlerimiz hakkında daha fazla bilgi için lütfen bizimle iletişime geçin.
                    </p>
                </div>
                ...
                <div className="themesflat-contact-form style-2 clearfix">
                    <form action="#" method="post" className="form-submit contact-form wpcf7-form">
                        ...
                        <span className="wpcf7-form-control-wrap your-phone">
                            <input type="text" tabIndex={2} id="phone" name="phone" defaultValue={""} className="wpcf7-form-control"
                                placeholder="Phone" />
                        </span>
