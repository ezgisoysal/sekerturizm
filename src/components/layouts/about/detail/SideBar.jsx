                        ...
                        <div className="inner">
                            <ul className="list-wrap">
                                <li className="list-item">
                                    <Link to="#"><span className="text">Who we are?</span></Link>
                                </li>
                                <li className="list-item">
                                    <Link to="#"><span className="text">Leadership Team</span></Link>
                                </li>
                                <li className="list-item">
                                    <Link to="#"><span className="text">Careers</span></Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="widget widget_lastest_twitter margin-top-40">
                        ...
                        <ul className="lastest-posts clearfix">
                            <li className="clearfix">
                                ...
                                <div className="text">
                                    <p><Link to="#">@Niche_Theme</Link> Lorem Ipsum has been the industry's standard dummy text ever
                                        since.</p>
                                </div>
                            </li>
                            <li className="clearfix">
