                        ...
                        <div id="breadcrumbs">
                            <div className="breadcrumbs-inner">
                                <div className="breadcrumb-trail">
                                    <Link to="home.html" className="trail-begin">Anasayfa</Link>
                                    <span className="sep">{this.props.data.border}</span>
                                    <Link to={this.props.data.links} onClick={() => {window.location.href=this.props.data.links}} className="trail-begin">{this.props.data.titlelink}</Link>
