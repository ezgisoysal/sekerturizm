    ...
    constructor(props) {
        ...
        this.state = {
            headers: [
                {
                    id: 1,
                    logoweb: "assets/img/seker/logo.jpg",
                    names: "Contact",
                }
            ],
            banners: [
            ...
            headingcontact: [
                {
                    ...
                    classnames: 'heading',
                    title: 'İLETİŞİM',
                    text: 'Şeker Turizm Hizmetlerini öğrenmek ister misiniz? Hizmetlerimiz hakkında daha fazla bilgi için lütfen bizimle iletişime geçin.',
